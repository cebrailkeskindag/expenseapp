  ...
  List<CategoryExpense> get categoryExpenses {
    return [
      CategoryExpense.forCategory(
          expenses, Category.education), //Eğitim harcamaları kategorisi
      CategoryExpense.forCategory(
          expenses, Category.work), //İş harcamaları kategorisi
      CategoryExpense.forCategory(
          expenses, Category.travel), //Gezi harcamaları kategorisi
      CategoryExpense.forCategory(
          expenses, Category.food), //Yemek harcamaları kategorisi
    ];
  }
